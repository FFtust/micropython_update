 ...
 * \brief      Get communication channel tag
 * @file       codey_get_chn.h
 * @author     Leo lu
 * @version    V1.0.0
 * @date       2017/11/17
 *
...
#ifndef _CODEY_GET_CHN_H_
#define _CODEY_GET_CHN_H_
#include <stdint.h>
#include <string.h>
#include <stdio.h>
...
extern const char *codey_get_chn_tag(channel_data_tag_t chn);

#endif /* _CODEY_GET_CHN_H_ */
