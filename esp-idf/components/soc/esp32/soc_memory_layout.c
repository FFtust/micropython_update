...
const soc_memory_type_desc_t soc_memory_types[] = {
    ...
    // Begin makeblock 20171106 by Yanminge
    ...
    { "D/IRAM", { MALLOC_CAP_MP_HEAP, MALLOC_CAP_DMA|MALLOC_CAP_8BIT|MALLOC_CAP_INTERNAL|MALLOC_CAP_DEFAULT, MALLOC_CAP_32BIT|MALLOC_CAP_EXEC }, true, true},
    // End makeblock 20171106 by Yanminge
    //Type 2: IRAM
